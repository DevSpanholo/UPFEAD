                ...
                <div class="p-5">
                  ...
                  <form action="{{ route('login.action') }}" method="POST" class="user">
                    ...
                    <div class="form-group">
                      <input name="email" type="email" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Insira um email...">
                    </div>
                    <div class="form-group">
